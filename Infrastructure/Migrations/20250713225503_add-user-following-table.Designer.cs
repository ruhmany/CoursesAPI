...
namespace RahmanyCourses.Infrastructure.Migrations
{
    ...
    [Migration("20250713225503_add-user-following-table")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RahmanyCourses.Core.Entities.UserFollow", b =>
                {
            ...
            modelBuilder.Entity("RahmanyCourses.Core.Entities.UserFollow", b =>
                {
                    b.HasOne("RahmanyCourses.Core.Entities.User", "Follower")
                        .WithMany("Followings")
                        .HasForeignKey("FollowerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("RahmanyCourses.Core.Entities.User", "Following")
                        .WithMany("Followers")
